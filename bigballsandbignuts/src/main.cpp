...
void opcontrol() {
    ...
    pros::Motor right_front_wheel(RIGHT_FRONT_WHEEL_PORT);
    pros::Motor right_back_wheel(RIGHT_BACK_WHEEL_PORT);
    ...
    while (true) {
        int dtY = master.get_analog(pros::E_CONTROLLER_ANALOG_RIGHT_Y);
        int dtX = master.get_analog(pros::E_CONTROLLER_ANALOG_RIGHT_X);
